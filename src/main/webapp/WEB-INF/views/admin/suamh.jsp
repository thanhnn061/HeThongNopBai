				...
				<div class="span9">
					...
					<div class="block">
						<div class="block-content collapse in">
							...
							<div class="block-content collapse in">
								<div class="span12">
									<form:form modelAttribute="suaMonHoc" method="POST"
										action="${pageContext.request.contextPath}/admin/suamh/hoanthanh/${suamonhoc.maMH }"
										enctype="multipart/form-data" onsubmit="return myFunction()">
										<fieldset>
											<legend> Môn Học</legend>
											<div class="control-group">

												<label class="control-label" for="typeahead">Mã
												Môn Học </label>
												<div class="controls">
													<form:input path="maMH" type="text" class="span6" id="maMH" value="${suamonhoc.maMH }" />
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<form:input path="tenMH" type="text" class="span6"
														id="tenMH" value="${ suamonhoc.tenMH}" />
												</div>
											</div>
