					...
					<div class="block">
						<div class="navbar navbar-inner block-header">
							...
							<div class="pull-right">
								<a href="${pageContext.request.contextPath}/admin/themgv">
									<button class="btn btn-primary btn-mini">Thêm Giảng
										viên</button>
								</a>
						...
						<div class="block-content collapse in">
							<table class="table table-striped">
								...
								<tbody>
									<c:forEach items="${loadgv}" var="g">
										<tr>
											<td>${g.maGV }</td>
											<td>${g.tenGV }</td>
											<td><a
												href="${pageContext.request.contextPath}/admin/xoagiangvien?maGV=${g.maGV }"
												return confirm('Bạn có chắc chắn muốn xóa mặt hàngnàykhông? ')">
													<button class="btn btn-primary btn-mini">Xóa</button>
											</a> <a
												href="${pageContext.request.contextPath}/admin/suagv/${g.maGV }"><button
														class="btn btn-primary btn-mini">Sửa</button></a> <a
												href="${pageContext.request.contextPath}/admin/xembai?magv=${g.maGV }">
