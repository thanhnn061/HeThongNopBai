				...
				<div class="span9">
					...
					<div class="block">
						<div class="block-content collapse in">
							...
							<div class="block-content collapse in">
								<div class="span12">
									<form:form modelAttribute="sinhVienInfo" method="POST"
										action="${pageContext.request.contextPath}/admin/themsv/add/"
										...
										<fieldset>
											...
											<div class="control-group">
												...
												<label class="control-label" for="typeahead">Mã
													Sinh viên </label>
												<div class="controls">
													<form:input path="maSV" type="text" class="span6" id="maSV" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label" for="typeahead">Tên
													Sinh Viên </label>
												<div class="controls">
													<form:input path="tenSV" type="text" class="span6"
														id="tenSV" />
												</div>
											</div>
