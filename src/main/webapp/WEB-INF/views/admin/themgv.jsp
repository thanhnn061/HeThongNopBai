				...
				<div class="span9">
					...
					<div class="block">
						<div class="block-content collapse in">
							...
							<div class="block-content collapse in">
								<div class="span12">
									<form:form modelAttribute="giangVienInfo" method="POST"
										action="${pageContext.request.contextPath}/admin/themgv/add/"
										enctype="multipart/form-data" onsubmit="return myFunction()">
										<fieldset>
											<legend>Thêm Giảng Viên</legend>
											<div class="control-group">

												<label class="control-label" for="typeahead">Mã
													Giảng Viên </label>
												<div class="controls">
													<form:input path="maGV" type="text" class="span6" id="maGV" />
												</div>
											</div>
											<div class="control-group">
