				...
				<div class="span9">
					...
					<div class="block">
						<div class="block-content collapse in">
							...
							<div class="block-content collapse in">
								<div class="span12">
									<form:form modelAttribute="suaGiangVien" method="POST"
										action="${pageContext.request.contextPath}/admin/suagv/hoanthanh/${suagiangvien.maGV }"
										enctype="multipart/form-data" onsubmit="return myFunction()">
										<fieldset>
											<legend> Giảng Viên</legend>
											<div class="control-group">

												<label class="control-label" for="typeahead">Mã
													Giảng Viên </label>
												<div class="controls">
													<form:input path="maGV" type="text" class="span6" id="maGV" value="${suagiangvien.maGV }" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label" for="typeahead">Tên
													Giảng Viên </label>
												<div class="controls">
													<form:input path="tenGV" type="text" class="span6"
														id="tenGV" value="${ suagiangvien.tenGV}" />
												</div>
											</div>
